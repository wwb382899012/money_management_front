...
Component.options.__file = "E:\\Projects\\money_management_front\\pages\\index\\pay\\transfer\\confirm.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-2a17b830", Component.options)
  } else {
    hotAPI.reload("data-v-2a17b830", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    // 确认打款成功
    confirmPayTransferSuccess: function confirmPayTransferSuccess(formName) {
      var _this3 = this;
      ...
      this.$refs[formName].validate(function (valid) {
        ...
        if (valid) {
          _this3.mconfirm('确认修改打款状态为成功吗？').then(function () {
            ...
            Object(__WEBPACK_IMPORTED_MODULE_0__api_pay__["h" /* payTransferConfirmSuccess */])({
    ...
    // 确认打款失败
    confirmPayTransferFail: function confirmPayTransferFail() {
      var _this4 = this;
      ...
      this.mconfirm('确认修改打款状态为失败吗？').then(function () {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_0__api_pay__["g" /* payTransferConfirmFail */])({
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
  ...
  }, [(_vm.reviewTransfer.transfer_status == '2' && _vm.reviewTransfer.pay_status == '10') ? _c('el-button', {
    attrs: {
    ...
    on: {
      "click": function($event) {
        _vm.confirmPayTransferSuccess('reviewTransfer')
      }
    }
  }, [_vm._v("确认打款成功")]) : _vm._e(), _vm._v(" "), (_vm.reviewTransfer.transfer_status == '2' && _vm.reviewTransfer.pay_status == '10') ? _c('el-button', {
    attrs: {
      "disabled": _vm.loading,
      "size": "medium",
      "type": "warning"
    ...
    on: {
      "click": _vm.confirmPayTransferFail
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-2a17b830", module.exports)
  }
}

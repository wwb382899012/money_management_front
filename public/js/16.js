...
Component.options.__file = "E:\\Projects\\money_management_front\\pages\\index\\repay\\order\\detail.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] detail.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-8d66f38e", Component.options)
  } else {
    hotAPI.reload("data-v-8d66f38e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    formatDetailData: function formatDetailData() {
      ...
      this.detailOrder.formatLoanAmount = this.filterCent2YuanCurrencyAmount([this.detailOrder.loan_amount, this.detailOrder.loan_currency]);

      this.detailOrder.currencyStr = this.mformatCurrencyStr(this.detailOrder.currency);

      this.detailOrder.loanCurrencyStr = this.mformatCurrencyStr(this.detailOrder.loan_currency);
      ...
      if (this.detailOrder.repay_annex) {
        try {
          this.detailOrder.repay_annex = JSON.parse(this.detailOrder.repay_annex);
          for (var i = 0; i < this.detailOrder.repay_annex.length; i++) {
            this.fileList.push({
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    slot: "header"
  }, [_c('span', [_vm._v("还款指令详情")])]), _vm._v(" "), _c('el-form', {
    ref: "detailOrder",
    attrs: {
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.detailOrder.loan_order_num)
    }
  })])], 1), _vm._v(" "), _c('div', {
    staticClass: "form-line"
  }, [_c('el-form-item', {
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.detailOrder.repay_main_body)
    }
  })]), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "借款方",
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.detailOrder.loanCurrencyStr)
    }
  })]), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "借款金额",
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.detailOrder.formatLoanAmount)
    }
  })])], 1), _vm._v(" "), _c('div', {
    staticClass: "form-line"
  }, [_c('el-form-item', {
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.detailOrder.require_repay_date)
    }
  })]), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "还款说明",
  ...
  }, [(_vm.detailOrder.repay_desc) ? _c('div', {
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.detailOrder.repay_desc)
    }
  }) : _c('div', {
    staticClass: "sub-text"
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.orderStatusJson[_vm.detailOrder.repay_order_status])
    }
  })])], 1), _vm._v(" "), _c('div', {
    staticClass: "form-line last-form-line"
  }, [_c('el-form-item', {
  ...
  }, [(_vm.detailOrder.loan_transfer_uuid) ? _c('transfer-detail', {
    attrs: {
      "uuid": _vm.detailOrder.loan_transfer_uuid
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-8d66f38e", module.exports)
  }
}

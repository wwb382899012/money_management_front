...
Component.options.__file = "E:\\Projects\\money_management_front\\pages\\index\\repay\\transfer\\detail.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] detail.vue: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7ffd0b84", Component.options)
  } else {
    hotAPI.reload("data-v-7ffd0b84", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  methods: {
    ...
    formatDetailData: function formatDetailData() {
      ...
      if (this.detailTransfer.orderDetail) {
        for (var i = 0; i < this.detailTransfer.orderDetail.length; i++) {
          if (this.detailTransfer.orderDetail[i].repay_order_status != 2 && this.detailTransfer.orderDetail[i].repay_order_status != 4) {
      ...
      this.detailTransfer.repay_bank_account_str = this.filterBankAccount(this.detailTransfer.repay_bank_account);
      this.detailTransfer.collect_bank_account_str = this.filterBankAccount(this.detailTransfer.collect_bank_account);
      ...
      if (this.detailTransfer.real_pay_type == '0' || !this.detailTransfer.real_pay_type) {
    ...
    sortCashFlowList: function sortCashFlowList() {
      ...
      for (var i = 0; i < this.detailTransfer.cashDetail.length; i++) {
        if (this.detailTransfer.cashDetail[i].index == this.detailTransfer.index && this.detailTransfer.cashDetail[i].cash_flow_type == 2) {
          this.detailTransfer.repay_amount = Number(this.detailTransfer.cashDetail[i].real_amount) + Number(this.detailTransfer.cashDetail[i + 1].real_amount);
          this.detailTransfer.repay_amount_str = this.filterCent2YuanNoThousandCurrencyAmount(this.detailTransfer.repay_amount);
          break;
        }
      }
    },
    ...
    // 获取当前行
    setCurrentRow: function setCurrentRow(_ref) {
      var row = _ref.row;

      if (this.detailTransfer.index == row.index && (row.cash_flow_type == 2 || row.cash_flow_type == 3)) {
        return 'success-row';
      }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    slot: "header"
  }, [_c('span', [_vm._v("还款调拨详情")])]), _vm._v(" "), _c('el-form', {
    ref: "detailTransfer",
    attrs: {
      "model": _vm.detailTransfer,
      "label-width": "120px",
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.detailTransfer.repay_transfer_num)
    }
  })]), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "借款编号",
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.detailTransfer.order_num)
    }
  })])], 1), _vm._v(" "), _c('div', {
    staticClass: "form-line last-form-line"
  }, [_c('el-form-item', {
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.repayTransferStatusJson[_vm.detailTransfer.repay_transfer_status])
    }
  })]), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "还款状态",
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.repayPayStatusJson[_vm.detailTransfer.repay_status])
    }
  })])], 1), _vm._v(" "), (_vm.detailTransfer.orderDetail && _vm.detailTransfer.orderDetail.length) ? _c('el-card', {
    staticClass: "box-card box-card-inside"
  }, [_c('div', {
    ...
    attrs: {
      "data": _vm.detailTransfer.orderDetail
    }
  }, [_c('el-table-column', {
    attrs: {
      "label": "操作",
    ...
    attrs: {
      "data": _vm.detailTransfer.cashDetail,
      "row-class-name": _vm.setCurrentRow
    }
  }, [_c('el-table-column', {
    attrs: {
      "prop": "repay_date",
    ...
    scopedSlots: _vm._u([{
      key: "default",
      fn: function(scope) {
        return [_vm._v("\n                      " + _vm._s(_vm.filterCent2YuanCurrencyAmount([scope.row.real_amount, _vm.detailTransfer.currency])) + "\n                    ")]
      }
    }])
  }), _vm._v(" "), _c('el-table-column', {
    attrs: {
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.detailTransfer.repay_main_body)
    }
  })]), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "借款方",
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.detailTransfer.repay_bank_name)
    }
  })]), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "借款方银行名称",
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.detailTransfer.repay_bank_account_str)
    }
  })]), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "借款方银行账号",
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.detailTransfer.collect_bank_account_str)
    }
  })])], 1), _vm._v(" "), _c('el-form-item', {
    attrs: {
      "label": "实付类型",
    ...
    staticClass: "form-line",
    class: {
      'last-form-line': !_vm.detailTransfer.bank_img_file_uuid
    }
  }, [_c('el-form-item', {
    attrs: {
      "label": "还款币种",
    ...
    staticClass: "sub-text",
    domProps: {
      "textContent": _vm._s(_vm.detailTransfer.repay_amount_str)
    }
  }, [_c('template', {
    slot: "append"
  }, [_vm._v("元")])], 2)])], 1), _vm._v(" "), (_vm.detailTransfer.bank_img_file_uuid) ? _c('el-form-item', {
    attrs: {
      "label": "银行流水号",
      "prop": "bank_water"
    }
  ...
  }, [(_vm.detailTransfer.loan_transfer_uuid) ? _c('transfer-detail', {
    attrs: {
      "uuid": _vm.detailTransfer.loan_transfer_uuid
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-7ffd0b84", module.exports)
  }
}

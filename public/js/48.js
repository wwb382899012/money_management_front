...
Component.options.__file = "E:\\Projects\\money_management_front\\pages\\index\\loan\\transfer\\receipt.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b65901d4", Component.options)
  } else {
    hotAPI.reload("data-v-b65901d4", Component.options)
  }
        ...
        if (valid) {
          _this2.mconfirm('确定要提交银行流水回单吗?').then(function () {
            ...
            var params = {
              ...
              main_body_uuid: _this2.reviewTransfer.loan_main_body_uuid,
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    slot: "header"
  }, [_c('span', [_vm._v("借款调拨上传银行流水")])]), _vm._v(" "), _c('el-form', {
    ref: "reviewTransfer",
    attrs: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-b65901d4", module.exports)
  }
}

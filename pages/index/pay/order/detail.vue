        ...
        <el-form 
          ...
          <div class="form-line">
            ...
            <el-form-item 
              ...
              <div
                class="sub-text" 
                v-text="detailOrder.system_flag">
              </div>
            </el-form-item>
          </div>
          <div class="form-line">
            ...
            <el-form-item 
              ...
              <div 
                class="sub-text" 
                v-text="detailOrder.order_pay_type" 
              ></div>
            </el-form-item>
          </div>
          <div class="form-line">
            <el-form-item 
              ...
              <div 
                class="sub-text" 
                v-text="detailOrder.pay_main_body" 
              ></div>
            </el-form-item>
            <el-form-item 
              label="收款方" 
              ...
              <div 
                class="sub-text" 
                v-text="detailOrder.collect_main_body" 
              ></div>
            </el-form-item>
          </div>
          <div class="form-line">
            <el-form-item 
              ...
              <div 
                class="sub-text" 
                v-text="detailOrder.pay_bank_name ? detailOrder.pay_bank_name : '无'" 
              ></div>
            </el-form-item>
            <el-form-item 
              label="收款方银行名称" 
              ...
              <div 
                class="sub-text" 
                v-text="detailOrder.collect_bank_name ? detailOrder.collect_bank_name : '无'" 
              ></div>
            </el-form-item>
          </div>
          <div class="form-line">
            <el-form-item 
              ...
              <div 
                class="sub-text" 
              >
                {{ detailOrder.pay_bank_account ? filterBankAccount(detailOrder.pay_bank_account) : '无' }}
              </div>
            </el-form-item>
            <el-form-item 
              label="收款方银行账号" 
          ...
          <div class="form-line">
            <el-form-item 
              ...
              <div 
                class="sub-text" 
                v-text="detailOrder.currencyStr" 
              ></div>
            </el-form-item>
            <el-form-item
              label="收款行行号">
              <div class="sub-text">{{ detailOrder.collect_bank_link_code ? detailOrder.collect_bank_link_code : '-' }}</div>
            </el-form-item>
          </div>
          <div class="form-line">
            <el-form-item 
              ...
              <div 
                class="sub-text" 
                v-text="detailOrder.formatAmount" 
              ></div>
            </el-form-item>
            <el-form-item
              label="收款行省市"
              ...
              <div 
                class="sub-text" 
                v-text="detailOrder.collect_city_name" 
              ></div>
            </el-form-item>
          </div>
          <el-form-item 
            ...
            <div 
              class="sub-text" 
              v-text="detailOrder.bs_background ? detailOrder.bs_background : '无'" 
            ></div>
          </el-form-item>
          <div class="form-line">
            <el-form-item 
              ...
              <div 
                class="sub-text" 
                v-text="detailOrder.order_create_people" 
              ></div>
            </el-form-item>
            <el-form-item 
              label="要求付款日" 
              ...
              <div
                class="sub-text" 
                v-text="detailOrder.require_pay_datetime ? detailOrder.require_pay_datetime : '无'">
              </div>
            </el-form-item>
          </div>
          <el-form-item 
          ...
          <div class="form-line">
            <el-form-item label="指令状态">
              <div 
                class="sub-text" 
                v-text="orderStatusJson[detailOrder.order_status]" 
              ></div>
            </el-form-item>
            <el-form-item label="付款状态">
              <div 
                class="sub-text" 
                v-text="payStatusJson[detailOrder.pay_status]" 
              ></div>
            </el-form-item>
          </div>
          <div 

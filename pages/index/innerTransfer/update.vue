      ...
      <el-card>
        ...
        <el-form 
          ...
          <el-form-item 
            ...
            prop="main_body_uuid">
            <el-select 
              v-model="updateInnerTransfer.main_body_uuid" 
              placeholder="请选择调拨主体" 
          ...
          <div class="form-line">
            ...
            <el-form-item 
              ...
              <el-select 
                v-model="updateInnerTransfer.collect_account_uuid" 
          ...
          <div class="form-line">
            <el-form-item 
              ...
              <el-input 
                v-model="updateInnerTransfer.pay_bank_account" 
            ...
            <el-form-item 
              ...
              <el-input 
                v-model="updateInnerTransfer.collect_bank_account" 
          ...
          <div class="form-line">
            <el-form-item 
              ...
              prop="currency">
              <el-select 
                v-model="updateInnerTransfer.currency" 
                placeholder="请选择币种">
                <el-option 
                  label="人民币" 
                  value="CNY"></el-option>
            ...
            <el-form-item 
              ...
              prop="amount">
              <el-input 
                v-model="updateInnerTransfer.amount" 
                placeholder="请输入金额" 
                type="number">
          ...
          <div class="form-line">
            <el-form-item 
              ...
              <el-select 
                ...
                v-model="updateInnerTransfer.real_pay_type">
                <el-option 
                  value="2" 
                  label="银企"></el-option>
                <el-option 
            ...
            <el-form-item 
              ...
              prop="hope_deal_date">
              <el-date-picker 
                v-model="updateInnerTransfer.hope_deal_date" 
          ...
          <el-form-item
            label="银企付款备注"
            v-if="updateInnerTransfer.real_pay_type == 2"
            prop="pay_remark">
            <el-input v-model="updateInnerTransfer.pay_remark" placeholder="请输入内容" maxlength="50"></el-input>
          </el-form-item>
          <el-form-item 
            label="附件" 
            prop="annex_uuids">
          ...
          <el-form-item 
            ...
            <el-input 
              v-model="updateInnerTransfer.special_require" 
              type="textarea" 
          ...
          <el-form-item 
            ...
            label-width="0">
            <el-button 
              v-if="updateInnerTransfer.transfer_status == '0' || updateInnerTransfer.transfer_status == '4' || updateInnerTransfer.transfer_status == '5'"
              :disabled="loading" 
              size="medium" 
              type="primary" 
              @click="handleSave('updateInnerTransfer')">保存</el-button>
            <el-button 
              v-if="updateInnerTransfer.transfer_status == '0' || updateInnerTransfer.transfer_status == '4' || updateInnerTransfer.transfer_status == '5'"
              :disabled="loading" 
              size="medium" 
              type="success" 
              @click="handleSubmit('updateInnerTransfer')">提交</el-button>
            <tp-historyback 
...
export default {
  data() {
    ...
    const checkPayAccount = (rule, value, callback) => {
      if (
        ...
        value == this.updateInnerTransfer.collect_account_uuid
      ) {
    ...
    const checkCollectAccount = (rule, value, callback) => {
      if (
        ...
        value == this.updateInnerTransfer.pay_account_uuid
      ) {
  ...
  created() {
    if (!this.$route.params.uuid) {
      ...
      getInnerTransferDetail({
        ...
        .then(res => {
          Object.assign(this.updateInnerTransfer, res.data);
  ...
  methods: {
    // 格式化详情数据
    formatDetailData() {
      this.updateInnerTransfer.amount = (
        Number(this.updateInnerTransfer.amount) / 100
      ).toFixed(2);

      if (this.updateInnerTransfer.node_list) {
        this.updateInnerTransfer.node_list = this.updateInnerTransfer.node_list.filter(
          function(item) {
      ...
      if (this.updateInnerTransfer.annex) {
        for (let i = 0; i < this.updateInnerTransfer.annex.length; i++) {
          this.fileList.push({
        ...
        .then(res => {
          ...
          for (let i = 0; i < this.bankAccountList.length; i++) {
            if (
              ...
              this.updateInnerTransfer.pay_bank_name = this.bankAccountList[
                i
              ].bank_name;
              this.updateInnerTransfer.pay_bank_account = this.bankAccountList[
                i
              ].bank_account;
            ...
            if (
              ...
              this.updateInnerTransfer.collect_bank_name = this.bankAccountList[
                i
              ].bank_name;
              this.updateInnerTransfer.collect_bank_account = this.bankAccountList[
                i
              ].bank_account;
    ...
    payBankAccountSelectChange(bankUuid) {
      ...
      if (hasAccount) {
        if (
          this.updateInnerTransfer.collect_account_uuid &&
          this.$refs['updateInnerTransfer']
        ) {
          this.$refs['updateInnerTransfer'].validateField(
            'collect_account_uuid'
          );
        }
      } else {
          ...
          this.mconfirm(type == '1' ? '确定要保存吗？' : '确定要提交吗？')
            .then(() => {
              ...
              const params = JSON.parse(
                JSON.stringify(this.updateInnerTransfer)
              );
